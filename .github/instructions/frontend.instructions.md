---
name: Flutter Code Style & Guidelines
description: Flutter code style and project guidelines for the AI to follow when generating code, answering questions, or reviewing changes.
applyTo: '**/*.dart' 
---
